...
public class UpdateAlbumPropertyWithGivenValue implements Rule {

    private static final String AUDIO_FORMAT = ".mp3";

    private final String album;

    public UpdateAlbumPropertyWithGivenValue(String album) {
        this.album = album;
    }
    ...
    public void apply(File file) {
        ...
        if (isAudioFile(file)) {
            ...
            try {
                String oldValue = mediaFile.getID3V2Tag() != null ? mediaFile.getID3V2Tag().getAlbum() : "";
